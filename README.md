...
This is the working area for the **TSP-Enabled AI Agent Protocols** specification, an ongoing work of the AI and Human Trust Working Group of [Trust over IP](https://trustoverip.org), a [Linux Foundation Decentralized Trust](https://www.lfdecentralizedtrust.org/) project.

* [Editor's Copy](https://trustoverip.github.io/aimwg-tsp-enabled-ai-agent-protocols/)
